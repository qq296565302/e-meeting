var pickout = function() {
	...
	function r(e, t) {
		...
		r.setAttribute("style", "position:relative;float:left;");
	...
	function i(e) {
		var t, n = document.querySelector(".pk-modal"),
			r = e.DOM[e.currentIndex];
		n.setAttribute("class", n.getAttribute("class") + " -" + e.theme);
		var i = n.querySelector(".main");
		if(!i.children.length) {
			var c = document.querySelector(".pk-overlay"),
				o = [].slice.call(r),
				l = o.map(function(r, i) {
					return t = {
						index: i,
						item: r
					}, a(t, n, e)
	...
	function a(e, t, n) {
		var r = n.DOM[n.currentIndex],
			i = t.querySelector(".main"),
			a = document.createElement("li"),
			o = e.item.hasAttribute("selected") ? "-selected" : "";
	...
	function l() {
		if(!document.querySelector(".pk-overlay")) {
			...
			c.setAttribute("class", "close"), c.innerHTML = "&times;", document.body.appendChild(e), document.body.appendChild(t), t.appendChild(r), t.appendChild(i), i.appendChild(a), t.appendChild(c), t.appendChild(n), e.addEventListener("click", function(e) {
	...
	function u() {
		var e = document.querySelector(".pk-overlay"),
			t = document.querySelector(".pk-modal"),
			n = t.querySelector(".pk-search");
